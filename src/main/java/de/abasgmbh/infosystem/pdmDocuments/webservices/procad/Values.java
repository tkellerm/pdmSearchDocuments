...
@JsonPropertyOrder({
    "/Part/pdmPartID",
    "/Part/pdmPartProductGroup",
    "/Part/pdmPartProductGroupAddon",
    "/Part/pdmPartType",
    "/Part/pdmPartCreateUser",
    "/Part/pdmPartCreateDate",
    "/Part/pdmPartRemark",
    "/Part/pdmPartLockUser",
    "/Part/pdmPartLockDate",
    "/Part/pdmPartState",
    "/Part/pdmPartModifyDate",
    "/Part/pdmPartModifyUser",
    "/Part/pdmPartANID",
    "/Part/pdmPartSourceSystemID",
    "/Part/pdmPartBOMUnit",
    "/Part/pdmPartBasicMaterialName",
    "/Part/pdmPartBasicMaterialNumber",
    "/Part/pdmPartDimensions",
    "/Part/pdmPartStandards",
    "/Part/pdmPartUsage",
    "/Part/pdmPartName",
    "/Part/pdmPartItemNumber",
    "/Part/pdmPartStateModifyUser",
    "/Part/pdmPartStateModifyDate",
    "/Part/pdmPartRemarkLong",
    "/Part/pdmPartSpecificationLong",
    "/Part/pdmPartRevision",
    "/Part/pdmPartVersion",
    "/Part/pdmPartRevisionChainAncestor",
    "/Part/pdmPartRevisionChainVersion",
    "/Part/pdmPartRevisionChainIndex",
    "/Part/pdmPartGUID",
    "/Part/pdmPartERPStateID",
    "/Part/pdmPartERPErrorMessage",
    "/Part/pdmPartERPTopStateID",
    "/Part/pdmPartERPTopErrorMessage",
    "/Part/pdmPartState[v]",
    "/Part/pdmPartRevision[v]",
    "/Part/pdmPartVersion[v]",
    "/Part/pdmPartERPErrorMessage[v]",
    "/Part/pdmPartERPTopErrorMessage[v]"
})
public class Values {
